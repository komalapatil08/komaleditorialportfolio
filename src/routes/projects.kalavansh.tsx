...
const vaseAsset = { url: "/images/ea5f5fe7-kv-vase.jpg" };
const artisanAsset = { url: "/images/dbad618d-kv-artisan.jpg" };
const titleAsset = { url: "/images/b750287c-kv-title-hires.png" };
const meenakariAsset = { url: "/images/6cf1a055-kv-meenakari.jpeg" };
const sareeAsset = { url: "/images/449e719e-kv-saree.jpeg" };
const kurtiAsset = { url: "/images/80faa8af-kv-kurti.png" };
const ch3Girl = { url: "/images/ab7b5fa3-kv-ch3-girl.jpeg" };
const ch3Foot = { url: "/images/de36be88-kv-ch3-foot.jpeg" };
const ch3Hand = { url: "/images/fe23edeb-kv-ch3-hand.jpeg" };
const ch3Chikan = { url: "/images/c78acb05-kv-ch3-chikankari.jpeg" };
const ch3Man = { url: "/images/7a9c9d45-kv-ch3-man.jpeg" };
const ch3Elderly = { url: "/images/5f9a8e19-kv-ch3-elderly.png" };
...
const kvLogo = { url: "/images/829055c0-kv-logo.png" };
const ch6MeenakariQR = { url: "/images/e8ae1921-kv-ch6-meenakari-qr.jpeg" };
const ch6Pottery = { url: "/images/574c1f6f-kv-ch6-pottery.png" };
const ch6Custom = { url: "/images/80839084-kv-ch6-custom.png" };
const ch6SiteQR = { url: "/images/b1dbe0fa-kv-ch6-site-qr.jpeg" };
const ch6PhoneResult = { url: "/images/413b8f47-kv-ch6-phone-result.jpeg" };
const ch7StallFull = { url: "/images/ad1213f5-kv-ch7-stall-full.png" };
const ch7Poster = { url: "/images/29475729-kv-ch7-poster.jpeg" };
const ch7PosterWhatsapp = { url: "/images/ee9c7685-kv-ch7-poster-whatsapp.jpeg" };

const ch7Cups = { url: "/images/418341ef-kv-ch7-cups.jpeg" };
const ch7Saree = { url: "/images/dbf8e622-kv-ch7-saree.jpeg" };
const promiseArtisan = { url: "/images/22f696a8-kv-promise-artisan.png" };
const promiseCustomer = { url: "/images/4bd31dbe-kv-promise-customer.png" };
  ...
  return (
    ...
    >
      <div className="mx-auto flex max-w-[1400px] flex-col items-center">
        ...
        {/* Closing statement */}
        <div className="mx-auto mt-32 max-w-3xl text-center md:mt-44">
          <p
